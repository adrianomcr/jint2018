...
def replanning_heuristics(original_graph, virtual_graph, list_of_H, FILE_2):
    ...
    # Compute
    old_cost, list_cost = myLib.get_cost(original_graph, list_of_H, speeds, search_speeds)
    ...
    import time as tm
    heu_time = tm.time()
    sol, division = TAHEU.heuristic_loop(original_graph,speeds, search_speeds, Cuv, Cuv_sp, pts, pts_id,depots,FILE_2)
    ...
    new_cost, list_cost = myLib.get_cost(original_graph, new_Hists, speeds, search_speeds)
